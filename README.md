...
我关注如何把真实的问题转化成**可运行、可验证的 AI 应用**，从问题判断和工作流设计，到原型构建、验证与迭代。
...
| 项目 | 我在解决什么 |
| --- | --- |
| [ArrivalReady](https://github.com/qrx-joe/ArrivalReady) | 探索如何用证据而不是单纯的模型判断，检查国际访客接待准备情况，并在关键结论前保留规则检查和人工复核。 |
| [OneCase](https://github.com/qrx-joe/OneCase) | 将零散的社区居民反馈整理成可编辑、可追溯的事项，并在正式进入后续流程前保留人工确认。 |
| [EasyPhone AI](https://github.com/qrx-joe/EasyPhone_AI) | 面向海外华人家庭的手机使用辅助原型，把复杂操作拆成更小、更可逆的步骤，并探索诈骗风险场景下的安全边界。 |
| [LOOM](https://github.com/qrx-joe/LOOM) | 一个用于实践 AI 工作流、RAG、可视化流程和对话交互的全栈项目。 |
| [TeachOps](https://github.com/qrx-joe/TeachOps) | 探索多 Agent 如何辅助教学设计预审，以及在信息和证据不足时如何阻止流程过早向下执行。 |

更多实验和原型，包括 [LifeOPS](https://github.com/qrx-joe/LifeOPS)，可以在我的个人网站中查看。
...
我把**原型、模拟 Demo 和真实世界验证**看作不同程度的证据，也尽量不把尚未验证的能力描述成已经完成的成果。
...
| --- | --- |
| [ArrivalReady](https://github.com/qrx-joe/ArrivalReady) | Exploring evidence-based readiness checks for international visitor reception, with rule-based checks and human review around important conclusions. |
| [OneCase](https://github.com/qrx-joe/OneCase) | Turning fragmented resident feedback into editable and traceable community issues, with human confirmation before formal workflow entry. |
| [EasyPhone AI](https://github.com/qrx-joe/EasyPhone_AI) | A phone-assistance prototype for overseas Chinese families that breaks complex tasks into smaller, reversible steps and explores safety boundaries in scam-risk scenarios. |
| [LOOM](https://github.com/qrx-joe/LOOM) | A full-stack project for practicing AI workflows, RAG, visual flow building, and conversational interaction. |
| [TeachOps](https://github.com/qrx-joe/TeachOps) | Exploring how multi-agent systems can support teaching-design review and prevent downstream work when information or evidence is incomplete. |

More experiments and prototypes, including [LifeOPS](https://github.com/qrx-joe/LifeOPS), are available on my portfolio.
